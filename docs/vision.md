...
## Overview
This repository contains the database infrastructure for the Espresso ML project. It is a collection of Kubernetes manifests, Helm charts, and database schemas that provide the foundation for the project.

This repo focuses on the database infrastructure and does not contain any application code.
...
- Database infrastructure (this repository): PostgreSQL database with Kubernetes deployment
- API backend (located in the `../backend` directory): Built with Node.js and TypeScript

# Goals
- Provide a scalable and reliable database infrastructure for the Espresso ML project
